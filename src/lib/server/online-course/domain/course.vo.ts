...
export class CourseMinStudents {
	...
	public static create(value: number = 20): CourseMinStudents {
...
export class CourseMaxStudents {
	...
	constructor(public readonly value: number) {}
	public static create(value: number = 60): CourseMaxStudents {
...
export class CourseStartDate {
	...
	constructor(public readonly value: number) {}
	public static create(value: number): CourseStartDate {
...
export class CourseEndDate {
	...
	constructor(public readonly value: number) {}
	public static create(value: number, startDate: number): CourseEndDate {
...
export class CourseStatus {
	...
	public static create(value: EnumCourseStatus = EnumCourseStatus.PENDING): CourseStatus {
